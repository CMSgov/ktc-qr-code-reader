/**
 * Single source of truth for CMS Kill the Clipboard approved apps and known SHL manifest hosts.
 *
 * Where the list comes from
 * -------------------------
 * The approved apps list is derived from the CMS "Kill the Clipboard" initiative (health tech
 * ecosystem). CMS designates:
 *   - 12 early adopters (e.g. Apple, Google, Samsung, CVS Health, Flexpa, b.well, Zocdoc)
 *   - 71+ pledgees (e.g. HealthTree, GoodRx, Luma Health, SEQSTER)
 * Official program and participant list: https://www.cms.gov/health-tech-ecosystem/early-adopters
 * Kill the Clipboard page: https://www.cms.gov/health-tech-ecosystem/early-adopters/kill-the-clipboard
 *
 * This file is maintained by hand; there is no automated sync with CMS.
 */
...
/** Known SHL manifest hostnames for spoof mitigation. Populate from CMS or issuer docs. */
export const KNOWN_SHL_MANIFEST_HOSTS = [];
