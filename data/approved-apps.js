 ...
 *
 * This file is maintained by hand; there is no automated sync with CMS. When CMS adds or removes
 * participants, update APPROVED_APPS here, then run: npm run generate:approved-apps
 * (and for Core deployments: npm run build:core).
 *
 * Usage
 * -----
 * - Server imports this module.
 * - public/js/approved-apps.js is generated by: npm run generate:approved-apps
 */
